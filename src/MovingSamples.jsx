...
function MovingSamples(){
    ...
    useEffect(()=>{
        ...
        const tempLeft1 = 75 - (((progress2 - 0.5) * 2) * 62.5)
        const tempLeft2 = 66 - (((progress2 - 0.5) * 2) * 28.5)
        const tempLeft3 = 79 - (((progress2 - 0.5) * 2) * 16.5)
        const tempLeft4 = 70 + (((progress2 - 0.5) * 2) * 17.5)
        const tempTop2 = 40 - (((progress2 - 0.5) * 2) * (40-28))
        const tempTop3 = 44 - (((progress2 - 0.5) * 2) * (44-28))        
        const tempTop4 = 55 - (((progress2 - 0.5) * 2) * (55-28))
        setLeft1(tempLeft1)
        setLeft2(tempLeft2)
        setLeft3(tempLeft3)
        setLeft4(tempLeft4)
    ...
    return(
        <div className='moving-samples-wrapper' ref={(el) => {
            ...
            <h1 className='title-gradient title-size'>OUR DESIGN PORTFOLIO</h1>
            ...
            <MovingSampleCard img={Img1} title={title1} text={text1} id='homirx' startingLeft={left1} startingTop={top1.current} parentRef={parentRef} progress2={progress2}/>
